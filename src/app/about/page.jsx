...
<h2 className="text-center text-2xl mt-5 mb-5 sm:text-3xl sm:mb-9">À propos de moi</h2> 
<div className="flex flex-col items-center">

<div className="m-5"><p className="mb-3 sm:text-xl">Je m'appelle Marienka, et la photographie est pour moi une manière de capturer des instants précieux du quotidien. Toujours équipée de mon appareil photo, je pars à la découverte des scènes qui, à mes yeux, sont chargées d'émotions. J'aime immortaliser ces moments furtifs qui racontent une histoire, sans artifices. Pour moi, la photographie est un moyen d’explorer et de partager la beauté simple du monde qui nous entoure.</p>
...
<blockquote className="mb-3 sm:text-xl">
        <p>
